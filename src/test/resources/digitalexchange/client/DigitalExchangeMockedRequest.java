...
/**
 * Represents the information about a mocked HTTP request that can be used to simulate the behavior of a mocked DE instance.
 *
...
public class DigitalExchangeMockedRequest {
    ...
    private Filter[] getFilters() {
        ...
        if (urlParams != null) {
            urlParams.forEach((paramName, filterValue) -> {
                if (paramName.startsWith("filters[")) {
                    ...
                    String filterField = paramName.substring(endIndex + 2);
                    switch (filterField) {
                        case "attribute":
