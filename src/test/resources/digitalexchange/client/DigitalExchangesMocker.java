...
public class DigitalExchangesMocker {
    ...
    public DigitalExchangesMocker() {
        ...
        this.restTemplateFactory = mock(DigitalExchangeRestTemplateFactory.class);
    ...
    public DigitalExchangeRestTemplateFactory initMocks() {
        ...
        when(restTemplateFactory.createRestTemplate(any())).thenReturn(restTemplate);
