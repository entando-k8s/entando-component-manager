...
<div class="container">
    <header class="container">
        ...
        <ul class="sr-only">
            ...
            <li><a accesskey="2" href="#navigazioneprincipale"
                   title="vai al menù di navigazione principale del portale">Navigazione principale del portale</a>
                (accesskey: 2)
            </li>
            ...
            <li><a accesskey="4" href="#menusecondario" title="vai al menu utente post login">Menu post login</a>
                (accesskey: 4)
            </li>
            <li><a accesskey="5" href="#navigazionealternativa"
                   title="vai al menù di accesso rapido ai contenuti di portale">Navigazione alternativa</a> (accesskey:
                5)
            </li>
            <li><a accesskey="6" href="#menuservizio" title="vai ai servizi e informazioni">Servizi e informazioni</a>
                (accesskey: 6)
            </li>
            <li><a accesskey="7" href="#menusocial" title="INAIL nei Social Network">INAIL nei Social Network</a>
                (accesskey: 7)
            </li>
        ...
        <nav class="navbar navbar-expand-lg has-megamenu">
            <button class="custom-navbar-toggler" type="button" aria-controls="nav1" aria-expanded="false"
                    aria-label="Toggle navigation" data-target="#menuprincipale">
            ...
            <div class="navbar-collapsable" id="menuprincipale" style="display: none;">
                ...
                <form method="get" enctype="application/x-www-form-urlencoded"
                      action="https://www.inail.it/cs/internet/risultati_ricerca.html" id="searchForm"
                      name="searchForm">
                    <div class="navbar-form navbar-left searchsite" role="search" id="formRicerca">
                        ...
                        <p class="form-group">
                            ...
                            <input type="text" id="textWrite" name="textWrite"
                                   class="form-control ui-autocomplete-input" placeholder="Cerca nel portale"
                                   title="inserisci il parametro da cercare su tutto il sito" autocomplete="off">
                ...
                <div class="menu-wrapper">
                    <ul id="navigazioneprincipale" role="menu" class="navbar-nav">
                        <li class="dropdown nav-item"><a href="https://www.inail.it/cs/internet/istituto.html"
                                                         class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                         role="button" aria-expanded="false"> Istituto <span
                                        class="sr-only">                                    (selezionato)                                </span>
                            </a>
                            <div class="dropdown-menu">
                                <div class="visible-sm-block visible-md-block visible-lg-block">
                                    <h3>Istituto</h3>
                                    <p> Presentazione dell’Ente, della sua organizzazione amministrativa e territoriale,
                                        delle relazioni con altri enti e con organi e organismi internazionali. </p>
                                    <p>
                                        <button type="submit" class="btn btn-default"
                                                onclick="location.href = '/cs/internet/istituto.html';">vai alla sezione
                                        </button>
                                    </p>
                                </div>
                                <ul role="menu">
                        ...
                        <li class="dropdown nav-item"><a href="https://www.inail.it/cs/internet/attivita.html"
                                                         class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                         role="button" aria-expanded="false"> Attività <span
                                        class="sr-only">(selezionato)</span> </a>
                            <div class="dropdown-menu">
                                <div class="visible-sm-block visible-md-block visible-lg-block">
                                    <h3>Attività</h3>
                                    <p> Principali aree di azione volte a ridurre il fenomeno infortunistico, assicurare
                                        dai rischi e garantire la tutela dei lavoratori. </p>
                                    <p>
                                        <button type="submit" class="btn btn-default"
                                                onclick="location.href = '/cs/internet/attivita.html';">vai alla sezione
                                        </button>
                                    </p>
                                </div>
                                <ul role="menu">
                        ...
                        <li class="dropdown nav-item"><a href="https://www.inail.it/cs/internet/atti-e-documenti.html"
                                                         class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                         role="button" aria-expanded="false"> Atti e documenti <span
                                        class="sr-only">(selezionato)</span> </a>
                            <div class="dropdown-menu">
                                <div class="visible-sm-block visible-md-block visible-lg-block">
                                    <h3>Atti e
                                        documenti</h3>
                                    <p> Documentazione prodotta dagli Organi dell’Inail, protocolli d’intesa,
                                        convenzioni e accordi con enti e istituzioni, istruzioni operative e
                                        modulistica. </p>
                                    <p>
                                        <button type="submit" class="btn btn-default"
                                                onclick="location.href = '/cs/internet/atti-e-documenti.html';">vai alla
                                            sezione
                                        </button>
                                    </p>
                                </div>
                        ...
                        <li class="dropdown nav-item"><a href="https://www.inail.it/cs/internet/comunicazione.html"
                                                         class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                         role="button" aria-expanded="false"> Comunicazione <span
                                        class="sr-only">(selezionato)</span> </a>
                            <div class="dropdown-menu">
                                <div class="visible-sm-block visible-md-block visible-lg-block">
                                    <h3>Comunicazione</h3>
                                    <p> Contenuti per i media, documenti e informazioni istituzionali utili ad
                                        approfondire attività, finalità e conoscenza dell’Istituto </p>
                                    <p>
                                        <button type="submit" class="btn btn-default"
                                                onclick="location.href = '/cs/internet/comunicazione.html';">vai alla
                                            sezione
                                        </button>
                                    </p>
                                </div>
                        ...
                        <li class="dropdown nav-item"><a href="https://www.inail.it/cs/internet/servizi-per-te.html"
                                                         class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                         role="button" aria-expanded="false"> Servizi Per Te <span
                                        class="sr-only">(selezionato)</span> </a>
                            <div class="dropdown-menu">
                                <div class="visible-sm-block visible-md-block visible-lg-block">
                                    ...
                                    <p>
                                        <button type="submit" class="btn btn-default"
                                                onclick="location.href = '/cs/internet/servizi-per-te.html';">vai alla
                                            sezione
                                        </button>
                                    </p>
                                </div>
                        ...
                        <li class="dropdown nav-item"><a href="https://www.inail.it/cs/internet/supporto.html"
                                                         class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                         role="button" aria-expanded="false"> Supporto <span
                                        class="sr-only">(selezionato)</span> </a>
                            <div class="dropdown-menu">
                                <div class="visible-sm-block visible-md-block visible-lg-block">
                                    <h3>Supporto</h3>
                                    ...
                                    <p>
                                        <button type="submit" class="btn btn-default"
                                                onclick="location.href = 'https://profilazioneutenteinternet.inail.it/utilityredirect?contesto=SUPPORTO';">
                                            vai alla sezione
                                        </button>
                                    </p>
                                </div>
                        ...
                        <#else>
                            ...
                            <script>
                              var keycloak = Keycloak(
                                  '<@wp.info key="systemParam" paramName="applicationBaseURL" />keycloak.json');
                              keycloak.init({
                                onLoad: 'check-sso'
                            ...
                            <ul role="menu" class="nav navbar-nav navbar-right">
                                <li>
                                    <form action="<@wp.info key=" systemParam " paramName="applicationBaseURL " />do/login"
                                          method="get" class="form-horizontal margin-medium-top">
                                        <input type="hidden" name="redirectTo" value="<@wp.url/>"/>
                                        <input id="service" type="submit" value="Accedi ai servizi online"
                                               class="nav-link" style="padding: 15px 80px 14px 80px; border: 0"/>
                                    </form>
                                </li>
                            </ul>
                        </#if>
