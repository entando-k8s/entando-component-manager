...
@SpringBootTest(
        ...
        classes = {EntandoKubernetesJavaApplication.class, TestKubernetesConfig.class})
...
class EntandoHubIntegrationTest {
    ...
    @Test
    void testBundleGroupController() throws Exception {
    ...
    @Test
    void testBundleController() throws Exception {
        final String DEFAULT_REGISTRY_ID = getDefaultRegistryId();
        mockMvc.perform(MockMvcRequestBuilders
