...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT,
        classes = {EntandoKubernetesJavaApplication.class, TestSecurityConfiguration.class, TestKubernetesConfig.class, TestTenantConfiguration.class})
...
public class EntandoBundleApiTest {
    ...
    public void apiShouldMaintainCompatibilityWithAppBuilder() throws Exception {
        ...
        mockMvc.perform(get("/components").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("payload[0]", hasKey("installed")))
