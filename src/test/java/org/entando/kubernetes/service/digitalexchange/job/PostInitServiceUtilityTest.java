...
class PostInitServiceUtilityTest {
    ...
    void calculateBundleCodeFromPostInitItem_ShouldThrowError() {
        ...
        final PostInitItem item1 = PostInitItem.builder().name(testName.toString())
                .url(POST_INIT_BUNDLE_PUBLICATION_URL).build();
        ...
        final PostInitItem item2 = PostInitItem.builder().name(testCharNotValid)
                .url(POST_INIT_BUNDLE_PUBLICATION_URL).build();
        ...
        final PostInitItem item3 = PostInitItem.builder().name(testStartCharNotValid)
                .url(POST_INIT_BUNDLE_PUBLICATION_URL).build();
