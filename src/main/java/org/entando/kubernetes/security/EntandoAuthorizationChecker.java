...
@Component
@Profile("!test")
public class EntandoAuthorizationChecker implements AuthorizationChecker {
    ...
    public EntandoAuthorizationChecker(@Value("${entando.url}") final String entandoUrl, RestTemplate simpleRestTemplate) {
