...
public interface DigitalExchangesClient {
    ...
    /**
     * Calls in parallel all the configured and active DE instances and returns a combined result of all the responses.
     *
     ...
     * @param call information necessary to execute the HTTP call and process the result
