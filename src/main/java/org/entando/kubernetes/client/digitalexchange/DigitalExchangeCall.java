...
/**
 * Base class containing the information necessary to query a specific Digital Exchange endpoint, parse its response and combine multiple
 * responses provided by the same endpoint of different Digital Exchange instances.
 *
