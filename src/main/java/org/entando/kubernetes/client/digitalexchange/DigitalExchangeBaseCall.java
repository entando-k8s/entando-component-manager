...
/**
 * Contains all the information necessary for querying a specific Digital Exchange endpoint (HTTP method, URL segments, entity sent as
 * payload). This class should be used for describing a call in which it is necessary to retrieve the raw response (InputStream), while it
 * subclasses should be used when it is necessary to parse a response into a specific class and/or combine the result of multiple requests.
 */
public class DigitalExchangeBaseCall<R> {
    ...
    /**
     * This method can be used to handle specific HTTP status codes returned by the Digital Exchange instance. The exceptionHandler must
